...
// Thu May 20 17:44:58 2021 by ROOT version 6.22/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxparticle_ = 41981;
...
#ifdef mclusth_cxx
mclusth::mclusth(TTree *tree) : fChain(0) 
{
...
Int_t mclusth::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mclusth::LoadTree(Long64_t entry)
{
...
void mclusth::Show(Long64_t entry)
{
...
Int_t mclusth::Cut(Long64_t entry)
{
