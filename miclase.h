...
// Wed Feb 24 10:44:03 2021 by ROOT version 6.22/06
// from TTree sim/simulated showers
// found on file: DAT010205.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxshower = 1;
   static constexpr Int_t kMaxparticle_ = 122;
   static constexpr Int_t kMaxlong_ = 1;
   static constexpr Int_t kMaxcherenkov_ = 1;
...
#ifdef miclase_cxx
miclase::miclase(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DAT010205.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DAT010205.root");
      }
...
Int_t miclase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t miclase::LoadTree(Long64_t entry)
{
...
void miclase::Show(Long64_t entry)
{
...
Int_t miclase::Cut(Long64_t entry)
{
