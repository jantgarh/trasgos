...
//#define hghtfi 0 // Height/m of first interaction
#define fileout "xxx.txt" //
// ----------------------------------------------------------------
void mclusters::Loop()
{
...
// ================================================================================
    ...
    Int_t   ntgamc=0, ntelec=0, ntmuc=0, ntnc=0, ntpc=0, ntothc=0;
    ...
    Float_t x, y, dx, dy, x1, x2, y1, y2, r, rsq,
    ...
    fstream archivo;
    //archivo.open("sum_p_E5_2m.txt", fstream::out); //-    Corsika simulation
    archivo.open(fileout, fstream::out); //-    Corsika simulation
...
nshows = 4;   //-
   ...
   for (Long64_t ishow=0; ishow<nshows; ishow++) {     // Loop in showers
       ...
       hghtfi  = shower_FirstHeight/100; // h en metros
   ...
   //      Select type of particle
       ...
       //*
       //cout << endl;
       cout << "* IShower - NClustInSh:  " << ishow+1 << "  -  " << icshow <<  endl;
       //cout << "* Suma de clusters IDs (onmmeeeggg): " << tidclus << endl;
       cout << "* Distribucion (gemnpo): " << ntgamc << " " << ntelec << " " << ntmuc <<  " " << ntnc <<  " " << ntpc <<  " " << ntothc << endl;
           cout << "* Distribucion relativa/%: " << 100*ntgamc/nsecp << " " << 100*ntelec/nsecp << " " << 100*ntmuc/nsecp <<  " " << 100*ntnc/nsecp <<  " " << 100*ntpc/nsecp <<  " " << 100*ntothc/nsecp << endl;
       cout << "* ShIdClusters: 2Ele, 2MU, 2Ch, Oth: " << iclems << " " << iclmus << " " << iclmxs << " " << iclots << endl;
       cout << endl;
       //*/
       
       ngam = 0; nele=0; nmu=0; nn=0; np=0; noth=0;
       ntgamc=0; ntelec=0; ntmuc=0; ntnc=0; ntpc=0; ntothc=0;
