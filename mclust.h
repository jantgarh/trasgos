...
// Wed Jun  9 13:26:16 2021 by ROOT version 6.22/06
...
#ifdef mclust_cxx
mclust::mclust(TTree *tree) : fChain(0) 
{
...
Int_t mclust::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mclust::LoadTree(Long64_t entry)
{
...
void mclust::Show(Long64_t entry)
{
...
Int_t mclust::Cut(Long64_t entry)
{
