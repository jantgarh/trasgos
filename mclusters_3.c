// mclusters_3.C  Nuevo codigo basado en dat6_0 para construir clusters con todo tipo de particulas y con informacion mas precisa: tiempos y energias separados para electrones y muones.
// Version 3. Incluye la impresion de resumenes de particulas por shower.
// !!!!!
...
nshows = 4;   //-
   ...
   //      Select type of particle
       ...
       mshow[ishow][6]= nps;
       mshow[ishow][7]= ntoth;
       mshow[ishow][8]= iclems;
       mshow[ishow][9]= iclmus;
       mshow[ishow][10]= iclmxs;
       mshow[ishow][11]= iclots;
