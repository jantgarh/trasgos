...
// Fri Apr  9 13:03:27 2021 by ROOT version 6.22/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxparticle_ = 28302;
   static constexpr Int_t kMaxlong_ = 11;
...
#ifdef mclusters_cxx
mclusters::mclusters(TTree *tree) : fChain(0) 
{
...
Int_t mclusters::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mclusters::LoadTree(Long64_t entry)
{
...
void mclusters::Init(TTree *tree)
{
...
void mclusters::Show(Long64_t entry)
{
...
Int_t mclusters::Cut(Long64_t entry)
{
