...
// Wed May 26 18:50:03 2021 by ROOT version 6.22/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxparticle_ = 26461;
...
#ifdef mclustg_cxx
mclustg::mclustg(TTree *tree) : fChain(0) 
{
...
Int_t mclustg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mclustg::LoadTree(Long64_t entry)
{
...
void mclustg::Show(Long64_t entry)
{
...
Int_t mclustg::Cut(Long64_t entry)
{
